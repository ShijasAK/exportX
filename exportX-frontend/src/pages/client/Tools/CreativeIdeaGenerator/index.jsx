...
import { useGenerateCreativeIdeaDraft, useSaveCreativeIdeaDraft } from "../../../../config/query/toolsQuery";
import { useToneOfVoice } from "../../../../config/query/toneOfVoiceQuery";
import { useProject, useProjects } from "../../../../config/query/projectQuery";
...
const CreativeIdeaGenerator = () => {
  ...
  const useGenerateCreativeIdeaQuery = useGenerateCreativeIdeaDraft();
  const useSaveCreativeIdeaQuery = useSaveCreativeIdeaDraft();
  ...
  return (
    <Box padding={5}>
      <TableHeaderOptions
        action={() => { }}
        title={"Tools"}
        subtitle={"Tools/ Creative Idea Generator"}
      />
          ...
          <VStack>
            ...
            <Flex flexDirection={"column"} w={"399px"} flex={1}>
              <IconButton
                ...
                isLoading={useGenerateCreativeIdeaQuery.isPending}
                alignSelf={"flex-end"}
      ...
      <HStack justify={"flex-end"} mt={20}>
        ...
        <Button
          ...
          bg={getColor(colorKeys.secondary, colorMode)}
          color={getColor(colorKeys.primary, colorMode)}
          isLoading={useSaveCreativeIdeaDraft.isPending}
        >
...
export default CreativeIdeaGenerator;